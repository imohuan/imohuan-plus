...
function getColor(path) {
  ...
  return dlv(colors, key).replace("#", "") + toHex(Math.round(parseFloat(opacity) * 255));
}
...
monaco.editor.defineTheme("tw-light", {
  ...
  inherit: true,
  rules: [
    { foreground: getColor("gray.800"), token: "" },
    ...makeTheme({
      comment: "gray.400",
      string: "indigo.600",
      number: "gray.800",
  ...
  colors: {
    ...
    "editorSuggestWidget.focusHighlightForeground": "#" + getColor("indigo.500"),
...
monaco.editor.defineTheme("tw-dark", {
  ...
  inherit: true,
  rules: [
    { foreground: getColor("slate.50"), token: "" },
    ...makeTheme({
      comment: "slate.400",
      string: "sky.300",
      number: "slate.50",
  ...
  colors: {
    ...
    "editorSuggestWidget.selectedBackground": "#" + getColor("slate.400/0.12"),
